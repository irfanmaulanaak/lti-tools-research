      ...
      <div class="container py-8 px-4 text-gray-300">
        ...
        <div class="content-div hidden" id="android-content">
          ...
          <div class="flex flex-col items-center gap-2">
            ...
            <a class="p-4 py-2 bg-gray-800 cursor-pointer border rounded-lg" href="<?php echo $deelpink_android ?>" target="_blank">Deep Link</a>
          </div>
        </div>
        <div class="content-div hidden" id="vr-content">
          ...
          <div class="flex flex-col items-center gap-2">
            ...
            <a class="p-4 py-2 bg-gray-800 cursor-pointer border rounded-lg" href="<?php echo $deelpink_vr ?>" target="_blank">Deep Link</a>
          </div>
        </div>
      </div>
    </main>
